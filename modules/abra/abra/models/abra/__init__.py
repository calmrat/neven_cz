...
class InvoiceItem(BaseModel):
    ...
    ext_kod_k: int = Field(..., alias="ext_kod_k", description="External ID item count.")
    ...
    typ_vyp_ceny_k: Optional[str] = Field(None, description="Price calculation type key.")
    ...
    cena_mj_cenik_tuz: Optional[float] = Field(None, description="Domestic price list unit price.")
    ...
    kop_zkl_md_ucet: Optional[bool] = Field(None, description="Copy base debit account.")
    kop_zkl_dal_ucet: Optional[bool] = Field(None, description="Copy base credit account.")
    kop_dph_md_ucet: Optional[bool] = Field(None, description="Copy VAT debit account.")
    kop_dph_dal_ucet: Optional[bool] = Field(None, description="Copy VAT credit account.")
    kop_typ_uc_op: Optional[bool] = Field(None, description="Copy accounting operation type.")
    ...
    id_pol_obch_zdroj: Optional[str] = Field(None, description="Source business item ID.")
    ...
    clen_kon_vyk_dph: Optional[str] = Field(None, description="VAT performance classification.")
    kop_clen_kon_vyk_dph: Optional[bool] = Field(None, description="Copy VAT performance classification.")
    ...
    poplatek_parent_pol_fak: Optional[str] = Field(None, description="Parent fee invoice item.")
    ...
    vyrobni_cisla_prijata: Optional[str] = Field(None, description="Received production numbers.")
    vyrobni_cisla_vydana: Optional[str] = Field(None, description="Issued production numbers.")
...
class Invoice(BaseModel):
    ...
    dat_uhr: Optional[datetime] = Field(None, description="Settlement date of the invoice.")
    dat_termin: Optional[datetime] = Field(None, description="Term date of the invoice.")
    dat_real: Optional[datetime] = Field(None, description="Realization date of the invoice.")
    ...
    uvod_txt: Optional[str] = Field(None, description="Introductory text of the invoice.")
    ...
    sum_zkl_sniz2: Optional[float] = Field(None, description="Second reduced tax base amount.")
    ...
    sum_dph_sniz2: Optional[float] = Field(None, description="Second reduced VAT amount.")
    ...
    sum_celk_sniz2: Optional[float] = Field(None, description="Total second reduced amount.")
    ...
    sum_osv_men: Optional[float] = Field(None, description="Exempt amount in foreign currency.")
    sum_zkl_sniz_men: Optional[float] = Field(None, description="Reduced tax base amount in foreign currency.")
    sum_zkl_sniz2_men: Optional[float] = Field(None, description="Second reduced tax base amount in foreign currency.")
    sum_zkl_zakl_men: Optional[float] = Field(None, description="Basic tax base amount in foreign currency.")
    sum_zkl_celkem_men: Optional[float] = Field(None, description="Total tax base amount in foreign currency.")
    sum_dph_zakl_men: Optional[float] = Field(None, description="Basic VAT amount in foreign currency.")
    sum_dph_sniz_men: Optional[float] = Field(None, description="Reduced VAT amount in foreign currency.")
    sum_dph_sniz2_men: Optional[float] = Field(None, description="Second reduced VAT amount in foreign currency.")
    sum_dph_celkem_men: Optional[float] = Field(None, description="Total VAT amount in foreign currency.")
    sum_celk_sniz_men: Optional[float] = Field(None, description="Total reduced amount in foreign currency.")
    sum_celk_sniz2_men: Optional[float] = Field(None, description="Total second reduced amount in foreign currency.")
    sum_celk_zakl_men: Optional[float] = Field(None, description="Total basic amount in foreign currency.")
    ...
    postovni_shodna: Optional[bool] = Field(None, description="Indicates if the postal address is the same.")
    ...
    bez_polozek: Optional[bool] = Field(None, description="Indicates if there are no items.")
    ucetni: Optional[bool] = Field(None, description="Indicates if the invoice is accounting.")
    szb_dph_sniz: Optional[float] = Field(None, description="Reduced VAT rate percentage.")
    szb_dph_sniz2: Optional[float] = Field(None, description="Second reduced VAT rate percentage.")
    szb_dph_zakl: Optional[float] = Field(None, description="Basic VAT rate percentage.")
    uzp_tuzemsko: Optional[bool] = Field(None, description="Indicates if the invoice is domestic.")
    zuctovano: Optional[bool] = Field(None, description="Indicates if the invoice is settled.")
    dat_ucto: Optional[datetime] = Field(None, description="Accounting date.")
    vyloucit_saldo: Optional[bool] = Field(None, description="Indicates if the balance is excluded.")
    ...
    metoda_zaokr_dokl_k: Optional[str] = Field(None, description="Rounding method for document.")
    vytvaret_kor_pol: Optional[bool] = Field(None, description="Indicates if correction items should be created.")
    ...
    dph_sniz2_ucet: Optional[str] = Field(None, description="Second reduced VAT account.")
    ...
    prikaz_sum_men: Optional[float] = Field(None, description="Order sum in foreign currency.")
    juh_sum: Optional[float] = Field(None, description="Settlement sum.")
    juh_sum_men: Optional[float] = Field(None, description="Settlement sum in foreign currency.")
    juh_dat: Optional[float] = Field(None, description="Settlement date.")
    juh_dat_men: Optional[float] = Field(None, description="Settlement date in foreign currency.")
    zbyva_uhradit: Optional[float] = Field(None, description="Remaining amount to be paid.")
    zbyva_uhradit_men: Optional[float] = Field(None, description="Remaining amount to be paid in foreign currency.")
    ...
    juh_sum_pp_men: Optional[float] = Field(None, description="Partial payment sum in foreign currency.")
    sum_prepl: Optional[float] = Field(None, description="Overpayment sum.")
    sum_prepl_men: Optional[float] = Field(None, description="Overpayment sum in foreign currency.")
    sum_zalohy: Optional[float] = Field(None, description="Advance payment sum.")
    sum_zalohy_men: Optional[float] = Field(None, description="Advance payment sum in foreign currency.")
    ...
    zaokrouhlit_po_odpoctu: Optional[bool] = Field(None, description="Round after deduction.")
    ...
    sum_celkem_bez_zaloh: Optional[float] = Field(None, description="Total amount without advances.")
    sum_celkem_bez_zaloh_men: Optional[float] = Field(None, description="Total amount without advances in foreign currency.")

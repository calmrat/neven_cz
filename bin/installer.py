...
def main():
    ...
    create_venv = input("Do you want to create a new virtual environment? (yes/no): ").lower() == 'yes'
    dev_install = input("Do you want to install with dev dependencies? (yes/no): ").lower() == 'yes'
    build_poetry_option = input("Do you want to build with poetry? (yes/no): ").lower() == 'yes'
